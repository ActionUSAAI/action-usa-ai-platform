...
export type JudgingEvidence    = { id: string; eventOrProcess: string; org: string; country: string; date: string; roleDescription: string; judgeSelectionCriteria: string; judgedEventSignificance: string; judgmentAuthorityAndConsequence: string; filePath: string; fileName: string };
