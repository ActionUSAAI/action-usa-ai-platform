...
import { resolveUploadNamespace, buildStoragePath } from "@/lib/intake/upload-authorization";
...
export async function POST(request: NextRequest) {
  try {
    ...
    // Ownership hardening (CR-CPS-35 IAG-38, remediated CR-CPS-38
    ...
    const storagePath = buildStoragePath(auth.invitationId, path, file.name);
